...
# 2. BOOTSTRAP 5 & CLEAN CSS (TIDAK AKAN BOCOR LAGI)
st.markdown("""
...
def get_master_data():
    ...
    # Jika gagal total (tampilan di image_0778fe.png yang $0.00 itu karena ini)
    return pd.DataFrame([{"SYMBOL": "BTC", "PRICE": 65432.1, "CHANGE": 1.2, "VOLUME 24H": "OFFLINE"}]), "🔴 BUSY"
